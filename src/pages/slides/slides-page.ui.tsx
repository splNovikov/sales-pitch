...
import { tatneftSolutionDetailSlides } from '~features/tatneft/slides/tatneft-solution-detail-slides';
...
import { eksimaPlatformSpecSlides } from '~features/eksima/slides/eksima-platform-spec-slides';
...
const slidesMap: Record<string, SlideData[]> = {
  ...
  'tatneft-solution-detail': tatneftSolutionDetailSlides,
  ...
  'eksima-platform-spec': eksimaPlatformSpecSlides,
