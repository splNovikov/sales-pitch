      ...
      <FeaturesSlide
        cards={[
          ...
          },
          {
            ...
            emoji: 'lightbulb',
            items: [
              'Сейчас лендинг играет роль разводящей страницы (отель / апартаменты)',
        ...
        cards={[
          {
            ...
            subtitle:
              '150 000 ₽ — Копирование текущей структуры сайта в новом современном дизайне. Структура страниц остаётся такой же, как сейчас, но визуально сайт полностью обновляется.',
            icon: <RocketOutlined />,
            iconColor: 'primary',
            emoji: 'rocket',
            items: [
          ...
          },
          {
            ...
            subtitle: '200 000 ₽ — Оптимальный баланс качества и инвестиций',
          ...
          },
          {
            ...
            subtitle:
              'от 350 000 ₽ — Всё из Продвинутого варианта + выделенная команда дизайнеров и полноценный дизайн-процесс',
            icon: <StarOutlined />,
            iconColor: 'gold',
            emoji: 'palette',
            items: [
