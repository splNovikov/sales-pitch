          ...
          >
            <Space direction="vertical" size="large" style={{ width: '100%' }}>
              ...
              >
                ...
                состоялся конструктивный диалог, и была достигнута
                договорённость о встрече в середине декабря для обсуждения
      ...
      <Space orientation="vertical" size="large" style={{ width: '100%' }}>
        <Card>
          ...
          >
            ...
            {'\n'} Проблема: отсутствие на маркетплейсах (Ozon, Wildberries) —
            упускается +20–30% выручки
