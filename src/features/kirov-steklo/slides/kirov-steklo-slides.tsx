            ...
            items={[
              {
                ...
                description: 'Полный контроль над процессом',
                icon: <GlobalOutlined />,
              },
              {
                title: 'Система проверяет и сохраняет данные',
                description: 'Собственная база данных',
                icon: <ThunderboltOutlined />,
              },
              {
                title: 'Автоматически создает номер заказа',
                description: 'Уникальная нумерация по вашим правилам',
                icon: <FileTextOutlined />,
              },
              {
                title: 'Проверяет наличие клиента в базе',
                description: 'Автоматическое связывание с историей',
                icon: <UserOutlined />,
              },
              {
                title: 'Рассылает уведомления по выбранным каналам',
                description: 'SMS, Telegram, WhatsApp, Email',
                icon: <MailOutlined />,
              },
              {
                title: 'Назначает менеджера автоматически',
                description: 'По загрузке или другим правилам',
                icon: <UserOutlined />,
              },
            ]}
          />
          ...
          <Col xs={24} sm={12}>
            <Card>
              ...
              <List
                size="small"
                dataSource={[
                  'Полностью под ваши процессы',
                  'Нет платежей за лицензии',
                  'Любые изменения когда нужно',
          ...
          <Col xs={24} sm={12}>
            <Card>
              ...
              <List
                size="small"
                dataSource={[
                  'Самые долгие сроки (9-11 месяцев)',
                  'Самая высокая стоимость разработки',
                  'Нужна сильная команда',
                  'Всю поддержку делаете сами',
                  'Больше рисков',
                ]}
                renderItem={item => (
                  <List.Item style={{ padding: '4px 0' }}>
