...
1. **Заявки приходят в разрозненном виде**
   - Клиенты отправляют заявки в свободной форме (текст, голос, фото)
   - Нет цели жестко формализировать заявку на входе, чтобы не снижать количество заявок
   - Требуется гибкая система распознавания и обработки неформализованных заявок

2. **Отсутствие централизованной IT-системы**
...
4. **Отсутствие прозрачности процессов**
...
5. **Разрозненные каналы коммуникации**
